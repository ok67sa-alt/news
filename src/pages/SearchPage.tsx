...
export default function SearchPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 font-ui">
      ...
      {/* Main Grid: Left Search Fields & Right Quick Tips */}
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        
        {/* Left Column (3/4 Width): Input field, filters, results */}
        <div className="lg:col-span-3 space-y-6">
          ...
          <form onSubmit={handleSearchSubmit} className="relative flex items-center shadow-sm">
            <input
              ...
              onChange={(e) => {
                ...
                // Also update the URL query parameter instantly for typing search synchronization
          ...
          {/* Results details & Sorting Options */}
        ...
        {/* Right Column (1/4 Width): Search Tips / Sideways Column */}
